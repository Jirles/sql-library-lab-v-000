...
def select_series_title_with_most_human_characters
  "SELECT s.title FROM series s INNER JOIN characters c ON c.series_id = s.id GROUP BY s.id HAVING MAX(COUNT((SELECT species FROM characters WHERE species = 'human')));"
end
